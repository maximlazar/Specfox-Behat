Feature: Specfox
    ...
    #    Then I resize the browser
        ...
        And I press "Sign in"
        Then I wait for 2 seconds
        Then I fill in "email" with "test@test.test"
    ...
    #    Then I resize the browser
        ...
        Then I fill in "last_name" with "Behat"
        Then I fill in "company_name" with a random surname
        ...
        Then I wait for 5 seconds
        And I should be on homepage
        Then I fill selector "#sign-up > div > div > div > div > div.colRight > form > div:nth-child(3) > input" with "test@gmail.com"
        Then I click on the element with css selector "#sign-up > div > div > div > div > div.colRight > form > button"
    ...
    #    Then I resize the browser
        ...
        Then I click on the element with css selector "#sign-up > div > div > div > div > div.colRight > form > button"
        Then I wait for "Get started by creating your first project!"
        Then I click on the element with css selector "#app > header > div > div.pull-right > div > div.profileMenu > span > span"
        Then I wait for 1 seconds
        Then I click on the element with css selector "#app > header > div > div.pull-right > div > div.profileMenu > ul > li.logout > a"
        Then I wait for "Easy Product Specification"
    ...
    #    Then I resize the browser
        ...
        Then I click on the element with css selector "#app > header > div > div.pull-right > div > div.profileMenu > span > span"
        Then I wait for 1 seconds
        Then I click on the element with css selector "#app > header > div > div.pull-right > div > div.profileMenu > ul > li.account > a"
        Then I wait for "My profile"
        Then I fill selector "#first_name" with a random name
        And I fill selector "#last_name" with "Behat"
        Then I fill selector "#email" with a random mail
        Then I fill selector "#company_name" with a random surname
        And I fill selector "#company_url" with "http://specfox.7.ns-qa.xyz/"
        Then I press "Save & Update"
        And I wait for "Profile was updated successfully"
    ...
    #    Then I resize the browser
        ...
        Then I press "Create project"
        Then I wait for "Upload screens"
        Then I attach the file "dummy.jpg" to selector field "body > input"
        Then I wait for 6 seconds
        Then grab a screenshot with a filename 1
    ...
    #    Then I resize the browser
        ...
        Then I fill selector "#sidebar > div > span > div > div > div > div > div" with a random text
        ...
        And I wait for 3 seconds
        Then I hover over the element "#sidebar > div > span > div:nth-child(1)"
        Then grab a screenshot
        ...
        Then I wait for 2 seconds
        Then I hover over the element "#content-wrapper > div > main > div > div.view-project-wrapper > div > div > div.clearfix.attachments > div > div > span > div:nth-child(2) > div > div.images > div.overlay"
        Then I wait for 1 seconds
        Then I click on the element with css selector "#content-wrapper > div > main > div > div.view-project-wrapper > div > div > div.clearfix.attachments > div > div > span > div:nth-child(2) > div > div.images > div.overlay > div > div.right-actions > button"
        Then I wait for 1 seconds
        Then I click on the element with css selector "#content-wrapper > div > main > div > div.view-project-wrapper > div > div > div.clearfix.attachments > div > div > span > div:nth-child(2) > div > div.images > div.overlay > div.singleDeleteConfirm > button.yes"
    ...
    #    Then I resize the browser
        ...
        Then I fill selector "#content-wrapper > div > main > div > div.view-project-description > div > div > div.tab-content > div > div > div > div > div.froala-wrapper.f-basic > div" with a random text
    ...
    #    Then I resize the browser
        ...
        Then grab a screenshot with a filename 2
        Then I click on the element with css selector "#content-wrapper > div > main > div > div.view-project-settings.projectSettingsContent > div > form > div:nth-child(4) > div.pull-right > div > p > span > label"
        Then I wait for 1 seconds
    ...
    #    Then I resize the browser
        ...
        Then I output the message "Please check the dowloaded PDF file manually"
    #    Given I have pdf located at "/Users/maximlazar/Downloads/797cc4aa-0442-43b7-b862-dd4dcf2a6ae3*"
